...
<body onload="registro()">
	...
	<div id="id01" class="modal">
		...
		<form class="modal-content"
			action="GestionDashboard?option=pwd-change" method="POST">

			<div class="container">
				<p>Rellena los campos</p>

				<label><b>Password actual</b></label>
				<p>${sessionScope.cu.password }</p>
				<label><b>Nueva password</b></label> <input type="text"
