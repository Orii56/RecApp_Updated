						...
						<div class="col-md-6 mb-5 mb-md-0" data-aos="fade-up">
							<form action="EmailSender?validar=send" method="post" role="form"
								...
								<div class="row">
									...
									<div class="col-md-6 form-group">
										<label for="name">Email</label> <input type="email" required
									...
									<div class="col-md-12 form-group">
										...
										<textarea class="form-control" required name="message"
											cols="30" rows="10" data-rule="required"
									...
									<div class="col-md-6 form-group">
										<input type="submit" class="btn btn-primary d-block w-100"
											value="Enviar Mensaje" onclick="itWorks()">
									</div>
								</div>
				...
				<div class="row justify-content-center text-center mb-5">
					<div class="col-md-4">
						...
						<span style="font-size: 10px;"><i>*Este test tiene un
								...
								del libro "La Sabiduría del Eneagrama" de Don Richard Riso y
								Russ Hudson.
						</i></span>
					</div>
				</div>
